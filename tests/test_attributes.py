...
from scimschema import attribute
...
def test_default_meta_attribute():
    ...
    assert re.search(
        re.compile(
            "\"_userName\"] and has 'mutability' property which must be .* "
            "but got 'invalid'"
        ),
        exception_msg,
    )
...
def test_binary_attribute_validate():
    schema = {"name": "data", "type": "binary", "required": True}
    data = {"data": "kjj"}
...
def test_complex_meta_attribute():
    d = {
        ...
        "multiValued": False,
        "description": (
            "The components of the user's real name. Providers MAY return "
        ...
        "subAttributes": [
            {
                ...
                "multiValued": False,
                "description": (
                    "The full name, including all middle names, titles, "
            ...
            },
            {
                ...
                "description": (
                    ...
                    "Western languages (e.g., 'Ms.' given the full name 'Ms. "
            ...
            },
            {
                ...
                "description": (
                    ...
                    "Western languages (e.g., 'III' given the full name 'Ms. "
                    "Barbara J Jensen, III')."
                ),
                "required": False,
                "caseExact": False,
...
def test_reference_meta_attribute():
    d = {
        ...
        "multiValued": False,
        "description": (
            "A fully qualified URL pointing to a page representing the "
...
def test_invalid_string_meta_attribute():
    schema = {
        ...
        "multiValued": False,
        "description": (
            "Unique identifier for the User, typically used by "
            "the user to directly authenticate to the service "
            "provider. Each User MUST include a non-empty "
            "userName value. This identifier MUST be unique "
    ...
    pattern = re.compile(r"'\(int\)123' \(at path.*\) is expected to be 'type string'")
    ...
    schema = {
        ...
        "subAttributes": [
            ...
            },
            {
                ...
                "multiValued": False,
                "description": (
                    "A label indicating the attribute's function, e.g., "
                    "'work' or 'home'."
                ),
                "required": False,
                "caseExact": False,
...
def test_multi_valued_invalid_complex_meta_attribute():
        ...
        "subAttributes": [
            ...
            },
            {
                ...
                "description": (
                    ...
                    "preferred attribute value for this "
                    "attribute, e.g., the preferred mailing "
                    "address or primary email address.  The "
                    "primary attribute value 'true' MUST appear "
                    "no more than once."
                ),
                "required": False,
                "mutability": "readWrite",
    ...
    pattern_invalid_str = re.compile(
        r"\'\(bool\)False\' \(at path: "
        r"urn:ietf:params:scim:schemas:test:multi_complex_attribute/emails"
        r"/type\) is expected to be \'type string\'"
    )
